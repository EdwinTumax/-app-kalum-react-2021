...
export default function RegisterUser() {
    ...
    const registerUser = ({apellidos,nombres,direccion,email,telefono,username,password}) => {
       const errores = {};
       setErrores(errores);
       ...
       if(validator.isEmpty(direccion)){
        errores.direccion = 'El campo dirección no debe estar vacio';
       }
       ...
       if(validator.isEmpty(username)){
        errores.username = 'El campo username no debe estar vacio';
       }
       ...
       dispatch(accountCreated({apellidos,nombres,direccion,email,telefono,username,password})).then(response => {
           Swal.fire({
               icon: 'success',
               title: 'Crear cuenta',
